...
- <tt>sdoc-all</tt> - command line tool to get documentation for ruby, rails, gems and plugins in one place
...
running <tt>rake</tt> (or <tt>rake update</tt>) in that folder:
